...
## Localization Perfect: single car simulator and full stack
...
## PF localization: corrected simulator, PF, and manual full stack
...
## Onboard/default command placeholder
...
## Step 3.1 closed-loop smoke check
...
## Step 3.2A recorded baseline and performance matrix check

Use a descriptive run ID, for example:
